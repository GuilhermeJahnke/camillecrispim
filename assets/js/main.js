...
(function() {
  ...
  function SendContect(){
    ...
    if(name === "" || email  === ""  || about  === ""  || message  === "" ){
      ...
      fetch('https://script.google.com/macros/s/AKfycbyX5Or2gZFPhrs5Dlj7UUlraSK7faiMVSuK8BzQx07UL1z83Ktyu0FDgO-mR71qU3FD/exec?name=' + name + "&email=" + email +"&about=" + about +"&message=" + message, {
      method: 'GET',
    })
      .then(response => {
